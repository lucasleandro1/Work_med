    ...
    <section class="home">
        ...
        <div class="form-flex">
            <div class="flex-content">
                ...
                <input type="text" name="cpf" id="cpf" required placeholder="Ex.: 123.456.789-00" maxlength="14" class="input-form" value="<?= $patient->getCpf() ?>">
            </div>
            ...
            <div class="flex-content">
                ...
                <select name="genero" id="genero" required class="input-form">
                    ...
                    <option value="masculino" <?= ($patient->getGen() === 'masculino') ? 'selected' : '' ?>>Masculino</option>
                    <option value="feminino" <?= ($patient->getGen() === 'feminino') ? 'selected' : '' ?>>Feminino</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-flex">
            <div class="flex-content">
                ...
                <input type="date" name="data_nascimento" id="data_nascimento" required placeholder="Ex.: 25/07/1986" class="input-form" value="<?= $patient->getDate() ?>">
            </div>
            <div class="flex-content">
                <label class="label-form" for="celular">Celular <span>*</span></label>
                <input type="text" name="celular" id="celular" required placeholder="Ex.: (88) 9 9653-3482" class="input-form" value="<?= $patient->getNum() ?>">
            </div>
        </div>
        ...
        <div class="form-flex">
            <div class="flex-content">
                ...
                <input type="text" name="endereco" id="endereco" required placeholder="Ex.: Rua São Paulo, 986" class="input-form" value="<?= $patient->getAdr() ?>">
            </div>
            <div class="flex-content">
                <label class="label-form" for="data_cirurgia">Data da Cirurgia <span>*</span></label>
                <input type="date" name="data_cirurgia" id="data_cirurgia" required placeholder="Ex.: 25/07/1986" class="input-form" value="<?= $patient->getDateSurgery() ?>">
            </div>
        </div>
            ...
            <div class="flex-content">
                ...
                <select name="sala" id="sala" class="input-form">
                    ...
                    <?php foreach ($roomNames as $name) { ?>
                        <option value="<?= $name ?>" <?= ($name === $patient->getRoomUsed()) ? 'selected' : '' ?>><?= $name ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="flex-content">
        ...
        <div class="procedure-flex">
            ...
            <div class="medic-choose">
                ...
                <div class="flex-content">
                    ...
                    <select name="medico" id="" class="sele-doc">
                        ...
                        <?php foreach ($doctorNames as $name) { ?>
                            <option value="<?= $name ?>" <?= ($name === $patient->getDoctor()) ? 'selected' : '' ?>><?= $name ?></option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div class="flex-content">
                    ...
                    <input type="text" name="gastos" id="gastos" placeholder="Ex: 258,43" class="gastos" value="<?= $patient->getExpenses() ?>">
                </div>
