...
<?php
    ...
    $surgeryId = $_GET['id'];
    $surgery = $surgeryDAO->getSurgeryById($surgeryId);
?>
<html>
<head>
    <meta charset='utf-8'>
...
<body>
   ...
   ?>
    ...
    <!-- --------------- InputFields --------------- -->
                ...
                <form method="POST" action="../php/PostSurgeryUpdate.php?id=<?= $surgeryId ?>" class="form">

                    <div class="flex-content">
                        <label for="nome" class="label-form">Nome do Tipo de Cirurgia <span>*</span></label>
                        <input type="text" name="nome" id="nome" value="<?= $surgery->getName() ?>" required placeholder="Ex.: Urologia" class="input-form-wd">
                    </div>

                    <div class="flex-content">
                        <label class="label-form"   for="descricao">Descrição <span>*</span></label>
                        <textarea type="text" name="descricao" id="descricao" value="<?= $surgery->getDescription()?>" required placeholder="Ex.: Ex.: Urologia é uma especialidade cirúrgica da medicina que trata do trato urinário de homens e..." class="input-form-wd"></textarea>
                    </div>
